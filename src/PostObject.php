...
class PostObject
{
    ...
    function __action_graphql_register_types($type_registry)
    {
        ...
        register_graphql_interface_type(
            ...
            [
                'description' =>
                    'A node that has a language code (Polylang)',
                'resolveType' => function ( \WPGraphQL\Model\Post $post ) use ( $type_registry ) {
                    return $type_registry->get_type('ContentNode')->config['resolveType']( $post );
                },
                'fields' => [
                    'language' => [
                        'type' => 'Language',
                    ...
                    'translations' => [
                        ...
                        //     $info
                        // ) {
                        //     return ['list_of' => $info->parentType];
                        // },
                        'description' => __(
